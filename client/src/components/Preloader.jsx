...
const Preloader = ({ onComplete }) => {
  ...
  return (
    <div className="preloader-container fixed inset-0 z-[9999] flex items-center justify-center overflow-hidden pointer-events-none">
      ...
      <div className="preloader-panel-top absolute inset-x-0 top-0 h-1/2 bg-white flex items-end justify-center overflow-hidden">
      ...
      <div className="preloader-panel-bottom absolute inset-x-0 bottom-0 h-1/2 bg-white flex flex-col items-center justify-start overflow-hidden">
        <div className="preloader-logo-half relative w-48 h-48 -translate-y-1/2 flex flex-col items-center justify-end">
          <img
            src="/logo.png"
            alt="Logo"
            className="w-full h-full object-contain"
        ...
        <div className="preloader-text -mt-[7.5rem] flex flex-col items-center z-20">
          ...
          <p className="text-[8px] font-bold text-zinc-400 tracking-[0.2em] uppercase mt-1.5">
            {loadingText}
          </p>
        </div>
      </div>
